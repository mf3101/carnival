...
Class Class_ASPdBManager
	...
	public function Connect(db,user,password,options)
		...
		on error resume next
			if return then dbManager.conn.Open openstring
	...
	public sub Disconnect()
		if (connected) then dbManager.conn.Close
		connected = false
		set rs = nothing
		set conn = nothing
	end sub
	...
	public function CreateNew(db,user,password,options,overwrite)
		...
		select case database
			...
			case "mysql"
				...
				Set rs = dbManager.conn.OpenSchema(20)
				if not rs.eof then
					if not overwrite then exit function 'overwrite not permitted
					do while not rs.eof
	...
	public function TableExists(tablename)
		...
		Set rs = dbManager.conn.OpenSchema(20,Array(Empty,Empty,tablename,Empty))
	...
	public function TablesOnDatabase()
		...
		dim return
		Set rs = dbManager.conn.OpenSchema(20,Array(Empty,Empty,Empty,Empty))
	...
	public function ColumnExists(tablename,columnname)
		...
		Set rs = dbManager.conn.OpenSchema(4,Array(Empty,Empty,tablename,columnname))
	...
	public function ColumnsOnTable(tablename)
		...
		dim return
		Set rs = dbManager.conn.OpenSchema(4,Array(Empty,Empty,tablename,Empty))
	...
	public function IndexExists(tablename,indexname)
		...
		if (database = "mdb") then
			Set rs = dbManager.conn.OpenSchema(10,Array(Empty,Empty,indexname,Empty,Empty,tablename,"UNIQUE"))
		elseif database = "mysql" then
			Set rs = dbManager.conn.Execute("SELECT * FROM information_schema.TABLE_CONSTRAINTS WHERE TABLE_CONSTRAINTS.TABLE_SCHEMA = '" & fString(currentdb) & "' AND TABLE_CONSTRAINTS.TABLE_NAME = '" & fString(tablename) & "' AND TABLE_CONSTRAINTS.CONSTRAINT_TYPE = 'UNIQUE' AND TABLE_CONSTRAINTS.CONSTRAINT_NAME = '" & fString(indexname) & "';")
		end if
	...
	public function IndexesOnTable(tablename)
		...
		on error resume next
		if (database = "mdb") then
			Set rs = dbManager.conn.OpenSchema(10,Array(Empty,Empty,Empty,Empty,Empty,tablename,"UNIQUE"))
		elseif database = "mysql" then
			Set rs = dbManager.conn.Execute("SELECT * FROM information_schema.TABLE_CONSTRAINTS WHERE TABLE_CONSTRAINTS.TABLE_SCHEMA = '" & fString(currentdb) & "' AND TABLE_CONSTRAINTS.TABLE_NAME = '" & fString(tablename) & "' AND TABLE_CONSTRAINTS.CONSTRAINT_TYPE = 'UNIQUE';")
		end if
	...
	public function ForeignKeyExists(tablename,foreignkeyname)
		...
		if (database = "mdb") then
			Set rs = dbManager.conn.OpenSchema(10,Array(Empty,Empty,foreignkeyname,Empty,Empty,tablename,"FOREIGN KEY"))
		elseif database = "mysql" then
			Set rs = dbManager.conn.Execute("SELECT * FROM information_schema.TABLE_CONSTRAINTS WHERE TABLE_CONSTRAINTS.TABLE_SCHEMA = '" & fString(currentdb) & "' AND TABLE_CONSTRAINTS.TABLE_NAME = '" & fString(tablename) & "' AND TABLE_CONSTRAINTS.CONSTRAINT_TYPE = 'FOREIGN KEY' AND TABLE_CONSTRAINTS.CONSTRAINT_NAME = '" & fString(foreignkeyname) & "';")
		end if
	...
	public function ForeignKeysOnTable(tablename)
		...
		if (database = "mdb") then
			Set rs = dbManager.conn.OpenSchema(10,Array(Empty,Empty,Empty,Empty,Empty,tablename,"FOREIGN KEY"))
		elseif database = "mysql" then
			Set rs = dbManager.conn.Execute("SELECT * FROM information_schema.TABLE_CONSTRAINTS WHERE TABLE_CONSTRAINTS.TABLE_SCHEMA = '" & fString(currentdb) & "' AND TABLE_CONSTRAINTS.TABLE_NAME = '" & fString(tablename) & "' AND TABLE_CONSTRAINTS.CONSTRAINT_TYPE = 'FOREIGN KEY';")
		end if
	...
	public function Paginate(byref Conn, byval database, recordsPerPage, Page, pagsql)
		...
		if m_RecordsPerPage = 0 then
			...
			if database = "mysql" then
				...
				m_Records = 0
				on error resume next
				set rs = dbManager.conn.execute(SQLfirst) 'first query
				...
				on error resume next
				set rs = dbManager.conn.execute(SQLsecond) 'second query
		...
		if godirect then
			on error resume next
			set rs = dbManager.conn.execute(SQL) 'second query
